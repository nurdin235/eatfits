    ...
    <div className="screen-wrapper">
      ...
      <div className="flex-1 overflow-y-auto no-scrollbar pb-32">
        <div className="px-4 pt-4 pb-2">
          ...
          <p className="text-primary/70 dark:text-primary/70 text-base mt-2">
              ...
              return (
                ...
                >
                  ...
                  <div className="flex flex-col flex-1">
                    <span className="font-bold text-foreground dark:text-white text-base">{goal.title}</span>
              ...
              return (
                <label key={tier.id} className="relative cursor-pointer group h-24">
                  ...
                  <div className={`flex flex-col items-center justify-center h-full rounded-xl border-2 transition-all ${
                    ...
                    <span className={`text-2xl font-bold mb-1 transition-colors ${isActive ? "text-primary" : "text-primary/40"}`}>
                      {tier.symbol}
                    </span>
                    <span className={`text-sm font-bold ${isActive ? "text-foreground dark:text-white" : "text-primary/60"}`}>
                      {tier.label}
                    </span>
                  </div>
                </label>
