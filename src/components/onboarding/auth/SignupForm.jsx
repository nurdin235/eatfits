  ...
  return (
    <div className="flex flex-col gap-5">
      <div className="input-group">
        <label className="text-gray-900 dark:text-gray-400 text-sm font-semibold ml-1">Full Name</label>
      ...
      <div className="input-group">
        <label className="text-gray-900 dark:text-gray-400 text-sm font-semibold ml-1">Confirm Password</label>
