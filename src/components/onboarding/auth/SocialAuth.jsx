  ...
  return (
    <>
      <div className="flex items-center gap-4 my-8 px-2">
        <div className="h-px bg-dark/10 dark:bg-dark/20 flex-1"></div>
        <p className="text-primary/60 text-sm font-medium">Or continue with</p>
        <div className="h-px bg-dark/10 dark:bg-dark/20 flex-1"></div>
      </div>

      <div className="flex gap-4 mb-6">
        <button type="button" aria-label="Continue with Google" className="flex-1 h-12 rounded-xl bg-surface-light dark:bg-surface-dark border border-dark/10 dark:border-dark/20 hover:bg-primary/5 dark:hover:bg-primary/10 transition-colors flex items-center justify-center gap-3 shadow-sm">
          ...
          <span className="text-foreground dark:text-white font-medium text-sm">Google</span>
        </button>
        <button type="button" aria-label="Continue with Apple" className="flex-1 h-12 rounded-xl bg-surface-light dark:bg-surface-dark border border-dark/10 dark:border-dark/20 hover:bg-primary/5 dark:hover:bg-primary/10 transition-colors flex items-center justify-center gap-3 shadow-sm">
          <svg className="w-5 h-5 text-foreground dark:text-white" fill="currentColor" viewBox="0 0 24 24">
          ...
          <span className="text-foreground dark:text-white font-medium text-sm">Apple</span>
        </button>
      </div>
    </>
  );
